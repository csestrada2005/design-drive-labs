  ...
  return (
    <section ref={ref as React.RefObject<HTMLElement>} className="min-h-screen flex items-center pt-20 pb-12">
      <div className="container max-w-4xl text-center">
        ...
        <h1
          className={`font-display text-[clamp(2.5rem,7vw,4.5rem)] leading-[1.1] tracking-tight mb-8 transition-all duration-700 delay-100 ${
        ...
        <div
          className={`flex flex-col sm:flex-row justify-center gap-4 mb-12 transition-all duration-700 delay-300 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
          }`}
        >
          <a
        ...
        <div
          className={`flex flex-wrap justify-center gap-12 pt-8 border-t border-border transition-all duration-700 delay-400 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
          }`}
        >
          {[
